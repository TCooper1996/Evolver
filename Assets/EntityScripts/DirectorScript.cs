...
public class DirectorScript : MonoBehaviour
{
    ...
    private RoomTuple _currentRoom;

    public static RoomTuple CurrentRoom
    {
    ...
    public static RoomTuple GetAdjacentTuple(RoomTuple pos, Direction d)
    {
    ...
    public static void CreatePickup(ShooterBehavior type, Vector3 pos)
    {
        ...
        {
            throw new NotImplementedException($"No implementation for pickup {type}");
        }
