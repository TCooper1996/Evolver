...
namespace ManagerScripts
{
    public class Room
    {
        ...
        public Room(Tuple<int, int> rt, int sceneIndex, int depth)
        {
    ...
    {
        private static Dictionary<Tuple<int, int>, Room> _world;
        ...
        public static void CreateLevels(int width, int height, int numberOfLevels)
        {
            ...
            Width = width;
            Height = height;
            var RootRoom = new Room(new Tuple<int, int>(4, 4), rootScene, 1);
            _world[new Tuple<int, int>(4, 4)] = RootRoom;

            for (var i = 0; i < numberOfLevels; i++)
            {
                var level = CreateLevel(RootRoom, 1, new List<Tuple<int, int>>());
        ...
        public static Room CreateLevel(Room CurrentRoom, int depth, List<Tuple<int, int>> visited)
        {
            ...
            var newVisited = new List<Tuple<int, int>>(visited);
        ...
        public static Dictionary<Tuple<int, int>, Room> GetWorld()
        {
            return _world;
        }
        ...
        /// <returns></returns>
        internal static bool RoomConnected(Tuple<int, int> pos, DirectorScript.Direction d)
        {
            var x = pos.Item1;
            var y = pos.Item2;
        ...
        public static Tuple<int, int> GetVectorFromDirection(Tuple<int, int> pos, DirectorScript.Direction d)
        {
        ...
        public static Room GetRoom(Tuple<int, int> t)
        {
            return _world[t];
        }
